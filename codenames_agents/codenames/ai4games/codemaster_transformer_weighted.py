...
from transformers import AutoModel, AutoModelWithLMHead,  AutoTokenizer, GPT2Tokenizer, TFGPT2Model, GPTNeoXTokenizerFast, GPTNeoXModel
...
class ai_codemaster(codemaster):
	...
	def __init__(self, brown_ic=None, glove_vecs=None, word_vectors=None):
		...
		self.tokenizer = GPTNeoXTokenizerFast.from_pretrained("gpt-neox-20b") ##GPT2Tokenizer.from_pretrained('gpt2')
		self.model = GPTNeoXModel.from_pretrained("gpt-neox-20b")  ##AutoModelWithLMHead.from_pretrained("gpt2")
